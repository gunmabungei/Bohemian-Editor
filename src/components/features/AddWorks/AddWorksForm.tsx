import {Button, FileInput, Group, Space, Textarea, TextInput} from "@mantine/core";
...
export const AddWorksForm = ({onChangeTabs, setFormValue, tabs, formValues}: AddWorksFormProps) => {
    return (<>
        <Tabs defaultValue="textInput" onChange={onChangeTabs} value={tabs}>
            <Tabs.List>
                <Tabs.Tab value="fileInput">
                    ファイル
                </Tabs.Tab>
                <Tabs.Tab value="textInput">
                    テキスト
                </Tabs.Tab>
            </Tabs.List>
            <Space h="sm"></Space>
            ...
            <Tabs.Panel value="textInput">
                <Textarea
                    ...
                    onChange={(event) => setFormValue({...formValues, body: event.target.value})}
                />
            </Tabs.Panel>
        </Tabs>
    </>)
