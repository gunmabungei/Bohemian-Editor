...
export default function Tabbar(props: {refreshCompontent: () => void}) {
    ...
    fetch(`http://localhost:3000/journal/props/byname/${params.journal_name}`)
        .then(res => res.json())
        .then(props => {setJournalName(props.title)})
    ...
    return (
        <>
            ...
            <Tabs
                ...
                onChange={(v) => { v != "file" ? navigate(`/edit/${params.journal_name}/${v}`) : setValue(true) }}
            >
                <Tabs.List>
            ...
            <Menu opened={value} onChange={changeMenu}>
                <Menu.Dropdown
                    ...
                    <NewJournal refreshComponent={props.refreshCompontent} onModalOpen={onModalOpen} onModalClose={onModalClose} />
                    <SelectJournal onModalOpen={onModalOpen} onModalClose={onModalClose} />
                </Menu.Dropdown>
            </Menu>
